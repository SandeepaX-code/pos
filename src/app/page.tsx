        ...
        <section className="rounded-[28px] border border-orange-100 bg-[linear-gradient(135deg,_rgba(255,255,255,0.96)_0%,_rgba(255,248,241,0.94)_100%)] p-6 shadow-[0_20px_70px_rgba(148,163,184,0.14)] md:p-8">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div className="max-w-4xl">
              <Badge className="px-3 py-1 bg-orange-100/60 text-orange-700 border border-orange-200 text-[10px] font-bold uppercase tracking-wider rounded-full">
                {isCashier ? "Cashier Operational Desk" : "Live operations overview"}
              </Badge>
              <h1 className="mt-4 font-[family-name:var(--font-display)] text-2xl font-semibold tracking-tight text-slate-950 md:text-4xl leading-tight md:leading-[1.15]">
                {isCashier
